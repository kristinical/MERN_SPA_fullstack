...
// Connect to the Atlas cluster based on the .env file parameters
mongoose.connect(
...
// Confirm the database has connected and print a message in the console
db.once("open", (err) => {
    if(err){
...
// Retrieve based on property filters and return a promise
